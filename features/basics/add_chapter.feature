...
Scenario: add second ao3 chapter
  ...
  When I am on the mini page
    ...
    And I press "Add Chapter w/o Fetching"
  Then I should have 3 pages
    And I should see "Added xyzzy to Time Was"
...
Scenario: paste actual html and get ao3 meta
  ...
  When I am on the mini page
    And I fill in "page_url" with "https://archiveofourown.org/works/692/chapters/804"
    And I press "Add Chapter w/o Fetching"
    And I store the raw html from "hogwarts"
...
Scenario: make an ao3 single into a book
  ...
  Then I should have 2 pages
    ...
    And I should see "xyzzy (Chapter)"
    And my page with title: "Time Was, Time Is" should not have a parent
...
Scenario: adding it;s chapter url after making a single into a book
  ...
  When I am on the first page's page
    ...
    And I press "Store w/o Fetching"
    And I press "Rebuild Meta"
  Then my page with title: "Where am I?" should have url: "https://archiveofourown.org/works/692/chapters/804"
...
Scenario: add second ff chapter (before)
  Given stuck exists
  Then I should have 2 pages
    And my page with title: "Stuck!" should have url: "https://www.fanfiction.net/s/2652996"
    And my page with title: "1:A Scowl Like a Thundercloud" should have url: "https://www.fanfiction.net/s/2652996/1"
...
Scenario: add second ff chapter
  ...
  When I am on the mini page
    ...
    And I press "Add Chapter w/o Fetching"
  Then I should have 3 pages
  And my page with title: "xyzzy" should have url: "https://www.fanfiction.net/s/2652996/2"
