Feature: read it (html or epub)

Scenario: read text is a download
  Given a page exists
  When I am on the first page's page
    And I follow "Read"
  Then the temporary read file should exist
    But the temporary epub file should NOT exist
    And the temporary html file should NOT exist

Scenario: html is a "download"
  Given a page exists
  When I read it online
  Then the temporary html file should exist
    But the temporary epub file should NOT exist
    And the temporary read file should NOT exist

Scenario: epub downloads (requires html first)
  Given a page exists
  When I download its epub
  Then the temporary epub file should exist
    And the temporary html file should exist
    But the temporary read file should NOT exist
...
Scenario: removing downloads
  ...
  Then the temporary html file should NOT exist
    And the temporary epub file should NOT exist
