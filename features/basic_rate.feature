Feature: basic rate
  ...
  Scenario: Changing read after orders
    ...
    Then I should see "Please rate (converted to years for next suggested read date)"
      And I press "5"
    Then I should see "Page set for reading again on 2014"
      And I should see "Alice's Adventures In Wonderland"
    When I follow "Rate"
    And I press "3"
    Then I should see "Page set for reading again on 2012"
      And I should see "Pride and Prejudice"
    When I press "Next"
    Then I should see "The Mysterious Affair at Styles"
    When I follow "Rate"
    And I press "4"
    Then I should see "Page set for reading again on 2013"
      And I should see "The Call of the Wild"
    When I press "Next"
    Then I should see "A Christmas Carol"
    When I follow "Rate"
      And I press "1"
    Then I should see "Page set for reading again on 2010"
    ...
    When I follow "Rate"
      And I press "100"
    Then I should see "Page set for reading again on 2109"
