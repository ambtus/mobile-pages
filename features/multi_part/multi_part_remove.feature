...
Scenario: remove a part from an existing page with parts (make single)
  Given a page exists with title: "Multi" AND base_url: "http://localhost:8080/tests/parts/*.html" AND url_substitutions: "1 3"
...
Scenario: remove a part from an existing page with parts (content)
  Given a page exists with base_url: "http://localhost:8080/tests/parts/*.html" AND url_substitutions: "1-3"
