...
Scenario: create Series from Singles & Books
  Given I have Books with titles "First" and "Third"
    And I have a Single with title "Second" and url "http://localhost:8080/tests/parts/3.html"
  ...
  Then I should see "Trilogy (Series)" within ".title"
    ...
    And "Original" should link to "http://localhost:8080/tests/parts/3.html"
...
Scenario: create by adding parents to a single and a book
  Given a page exists with title: "Parent" AND urls: "http://localhost:8080/tests/parts/2.html,http://localhost:8080/tests/parts/3.html"
    And a page exists with title: "Single" AND url: "http://localhost:8080/tests/parts/1.html"
  ...
  Then I should see "Grandparent (Series)" within ".title"
    ...
    And "Original" should link to "http://localhost:8080/tests/parts/1.html"
    And I should NOT see "parts" within "#position_2"
...
Scenario: create book by adding parts
  ...
  When I am on the first page's page
    ...
    And I refetch the following
      ...
      http://localhost:8080/tests/parts/4.html
      """
