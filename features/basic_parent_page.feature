Feature: different format for a parent page
  ...
  Scenario: parent read page
   ...
   When I am on the homepage
     And I follow "Read"
   Then I should see "Download Part 1"
     And I should see "Read Part 1"
     And I should see "Download Part 2"
     And I should see "Read Part 2"
     And I should not see "stuff for part 1"
     And I should not see "stuff for part 2"
   When I follow "Read Part 1"
