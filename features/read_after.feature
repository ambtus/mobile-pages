Feature: read_after order
  ...
  Scenario: Changing read after orders
    ...
    And I press "Rate"
    Then I should see "page 1 title set for reading again in 5 years"
    ...
    When I follow "page 3 title" within "#position_1"
      ...
      And I choose "upsetting"
    And I press "Rate"
    Then I should see "page 3 title set for reading again in 4 years"
    ...
    When I follow "page 5 title" within "#position_1"
      ...
      And I choose "very stressful"
    And I press "Rate"
    Then I should see "page 5 title set for reading again in 6 years"
      And I should see "page 4" within "#position_1"
      And I should see "page 2" within "#position_2"
