Feature: basic states
  ...
  Scenario: unread and favorite states
   ...
   Scenario: short state and long
    Given the following page
      |title | url |
      | Test | http://sidrasue.com/tests/short.html |
    When I am on the homepage
   ...
   When I follow "Refetch"
     When I fill in "url" with "http://sidrasue.com/tests/short.html"
     And I press "Refetch"
   Then I should see "short" in ".states"
     And I should not see "long" in ".states"
  ...
  Scenario: add epic state
    Given the following page
      ...
      | Multi | http://sidrasue.com/tests/long*.html| 1 2 3 4 5 6 7 8 |
   When I am on the homepage
