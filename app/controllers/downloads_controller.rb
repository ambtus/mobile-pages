...
protected
  ...
  def render_html
    ...
    # write to file
    File.open("#{@page.download_basename}.html", 'w') {|f| f.write(render_to_string(:template => "downloads/show", :formats => [:html], :layout => 'downloads.html'))}
  end
  ...
  def render_sections
    ...
    # write to file
    File.open("#{@page.download_basename}.read", 'w') {|f| f.write(render_to_string(:template => "downloads/read", :formats => [:html], :layout => 'downloads.html'))}
  end
