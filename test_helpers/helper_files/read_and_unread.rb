...
def read_and_unread_pages
  ...
  read_book
  unread_series
  partially_read_series
  read_series
end

def unread_single = Single.create(title: 'not read single')

def read_single = Single.create(title: 'yes read single').rate_today(5)
